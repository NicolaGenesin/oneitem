...
const i18n = rosetta({
  en: {
    ...
    components: {
      leftColumn: {
        alertInfo: 'Complete all fields on this column and see your product preview on your right! All fields are required. After the product is created, it will be visible to everyone.',
